...
const BlogCategory = () => {
  return (
    <div className="w-full px-[0px] sm:h-[537px] sm:max-w-[393px] lg:px-[41px]">
      ...
      <ul className="mt-[43px] w-full sm:px-[36px]">
        <li>
          <h1 className="mb-[33px] text-[18px] font-medium text-dark md:text-[24px]">Categories</h1>
        </li>
        <li className="mb-[41px] flex w-full items-center justify-between">
