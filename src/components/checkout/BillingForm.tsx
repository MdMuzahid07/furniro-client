  ...
  return (
    <section className="mx-auto w-full max-w-[1440px] px-[20px] pt-[40px] pb-[40px] sm:px-[40px] sm:pt-[50px] md:px-[60px] lg:px-[52px] lg:pt-[63px] lg:pb-[52px] xl:px-[100px]">
      <div className="grid grid-cols-1 gap-[26px] md:grid-cols-2">
        {/* billing => form */}
        <div className="px-[77.5px] pt-[25] pb-[40px] sm:pt-[35px] sm:pb-[50px] md:pb-[71px]">
          ...
          <form action="" className="space-y-[36px]">
            <div className="flex flex-col gap-[31px] sm:flex-row">
              <div>
                ...
                <input
                  className="mt-[22px] h-[75px] w-full rounded-[10px] border border-accent-light px-[18px] text-[20px] focus:border-primary focus:outline-none"
